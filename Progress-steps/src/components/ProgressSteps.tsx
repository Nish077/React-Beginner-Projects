...
const ProgressSteps = () => {
    ...
    return (
        <div className="flex flex-col items-center p-5">
            ...
            <motion.div
                className="text-center p-5 w-[40rem] shadow-md h-[10rem] border rounded-lg"
                key={currentStep}
            ...
            <div className="flex mt-5 space-x-4">
                <button className={`px-4 py-4 rounded text-white bg-blue-500 
                ...
                <button
                onClick={nextStep} className={`px-4 py-4 rounded text-white bg-blue-500  ${currentStep === steps.length - 1 ? 'opacity-50 cursor-not-allowed' : ""}
                    `}
